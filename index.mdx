...
<AccordionGroup>
  ...
  <Accordion title="Can I use this API to build my own energy app?">
    Yes — that is exactly what it is designed for. Embed Termina's bill extraction into energy comparison tools, solar calculators, property management platforms, ESG dashboards, or any custom application. The free tier gives you 50 credits to prototype with. See [Build an energy app](/guides/build-an-energy-app).
  </Accordion>
