---
title: "Quickstart — Extract Your First Energy Bill in 60 Seconds"
sidebarTitle: "Quickstart guide"
description: "Send your first energy bill and get structured JSON back in under a minute. Code examples in Python, Node.js, and cURL for the Termina bill data extraction API."
---
...
See the full [response schema](/api-reference/response-schema) for every field, type, and possible value.
...
<AccordionGroup>
  ...
  <Accordion title="How long does extraction take?">
    Most bills are processed in under 3 seconds. Complex multi-page bills
    or low-quality scans may take slightly longer. The API responds
    synchronously — no polling or webhooks required.
  </Accordion>
  ...
  <Accordion title="What happens if a bill cannot be fully parsed?">
    ...
    you always know what you can trust.
  </Accordion>
  ...
  <Accordion title="How do I authenticate API requests?">
    ...
    [app.termina.io](https://app.termina.io) — no credit card required.
  </Accordion>
  ...
  <Accordion title="What are the rate limits?">
    ...
    limit. See [Error handling](/api-reference/error-handling) for all
    status codes.
  </Accordion>
